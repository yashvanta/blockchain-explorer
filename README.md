...
![Workflow Diagram](Digram/workflow-diagram.png)

**Activity Diagram**

![Activity Diagram](Digram/activity-diagram.png)

**Database Schema**

![Database Schema](Digram/database-schema.png)

**Explorer View**

![Explorer](Digram/explorer.png)

**Analytics Dashboard**

![Analytics](Digram/analytics.png)

**Gas Price Trends**

![Gas Price](Digram/gas-price.png)

**Method Breakdown**

![Method Breakdown](Digram/method-breakdown.png)

**Monthly Transaction Volume**

![Monthly Transactions](Digram/monthly-transaction.png)

**Query Interface**

![Query](Digram/query.png)

**Accessibility Features**

![Accessibility](Digram/accessibility.png)
